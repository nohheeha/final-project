...
<!-- Bootstrap -->
    ...
    <link href="/resources/css/font-awesome.min.css" rel="stylesheet">
			...
			<div class="row4">
				...
				<input class="form-control" type="password" name="pwd" id="pwd" size="15" value="${member.password }" readonly="readonly" />
				</div>
				</div>
			    ...
			    <div class="form-group">
					...
					<input class="form-control"  type="text" name="name" id="name" size="15" value="${member.name }" readonly="readonly"  />
				</div>
				</div>
		        ...
		        <div class="form-group">
				  ...
				  <div class="col-md-12">
		          <div class="form-group">
					<a href="/Member/memberUpdateView"><button class="btn btn-primary9" id="updateBtn" type="button">회원수정</button></a>
					<a href="/Member/memberDeleteView"><button class="btn btn-primary9" id="deleteBtn" type="button">회원탈퇴</button></a>
