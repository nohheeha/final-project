    ...
    <link href="/resources/css/font-awesome.min.css" rel="stylesheet">
			...
			<div class="row4">
		        ...
		        <div class="form-group">
					...
					<input class="form-control" type="email" name="email" size="27" placeholder="abcd@domain.com" value="${member.email }"  />
				</div>
				</div>
		        ...
		        <div class="form-group">
					...
					<input class="form-control" type="phone" size="20" name="phone" placeholder="000-0000-0000" value="${member.phone }" >
				</div>
				</div>
				...
				<div class="col-md-12">
		          <div class="form-group">
					...
					<a href="/Member/memberDelete"><button class="btn btn-primary9" id="deleteBtn" type="button">회원탈퇴</button></a>
